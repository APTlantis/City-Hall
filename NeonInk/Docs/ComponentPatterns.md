> **NIPC alignment note:** This is a pre-NIPC component-pattern source document. Component structure remains useful, but color role decisions now flow through `NIPC—NeonInkPaletteContract.md`; artifact field/layout requirements flow through `AIC-v0.1-Aptlantis-Studio.md`.
