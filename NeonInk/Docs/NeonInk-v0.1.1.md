...
| Geometry | `APGC-v0.1.md` | Shape families, angle energy, corner profiles, safe zones, manga composition |
...
| Layer | Canonical Document | Responsibility |
|---|---|---|
| Meaning | [SESM v0.2.md](SESM-v0.2.md) | Metadata, identity, provenance, links, agent hints |
| Palette | [NIPC v0.1.1.md](NIPC-v0.1.1.md) | Color families, semantic roles, psychological intent, intensity validation |
| Contract | [AIC v0.1.1.md](AIC-v0.1.1.md) | Artifact types, required fields, layout regions, render targets |
| Expression | `NeonInk-v0.1-Aptlantis-Studio.md` | Typography, panel grammar, page composition, brand voice |
...
This addendum aligns Neon Ink with SFDS by clarifying implementation guidance that can be validated by real adopter projects such as FileCabinet.
