> **NIPC alignment note:** This is a pre-NIPC CSS/token source document. Treat its token snippets as historical implementation notes. The canonical palette is now `NIPC—NeonInkPaletteContract.md`; new CSS/Tailwind exports should use NIPC families and aliases while preserving the stable core tags.
